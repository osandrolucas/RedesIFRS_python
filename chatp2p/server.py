...
def worker():
    print(emojize('Thread Servidor Iniciada com Sucesso! :smile:', use_aliases=True))
    return
...
try:
    ...
    try:
        ...
        while 1:  # True
            ...
            # Recebendo
            print(emojize('Aguardando uma mensagem do Cliente :clock12: :clock2: :clock3: :clock4: :clock5: ...',
                          use_aliases=True))
